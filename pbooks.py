...
output_dir = os.path.join(os.path.dirname(excel_file), "pbooks")
log_file_path = os.path.join(os.path.dirname(excel_file), "pbook_creation_log.txt")
CREATE_PBOOK = False  # Set to True to also create .pbook files
